...
CREATE TABLE `cart_models` (
  ...
  `good_code` text COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `cart_models` (`id`, `order_id`, `good_code`, `cost`, `number`, `subtotal`, `created_at`, `updated_at`)
VALUES
	(12,1,'KZM-013',NULL,3,69000,'2017-08-11 05:22:10','2017-08-11 05:22:10'),
	(13,1,'AKL-V001',NULL,2,60000,'2017-08-11 05:22:10','2017-08-11 05:22:10'),
	(14,2,'KZM-013',NULL,1,23000,'2017-08-11 05:22:51','2017-08-11 05:22:51'),
	(15,3,'KZM-012',19000,2,38000,'2017-08-11 08:32:41','2017-08-11 08:32:41');
...
CREATE TABLE `inquiries` (
  ...
  `name_roma` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `name_kana` varchar(255) COLLATE utf8_unicode_ci DEFAULT '',
  `address_1` varchar(255) COLLATE utf8_unicode_ci DEFAULT '',
  `address_2` varchar(255) COLLATE utf8_unicode_ci DEFAULT '',
  `tel` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `email` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `requirement` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `daiichikibou` varchar(255) COLLATE utf8_unicode_ci DEFAULT '',
  `numbers_people` varchar(255) COLLATE utf8_unicode_ci DEFAULT '',
  `have_gone` varchar(255) COLLATE utf8_unicode_ci DEFAULT '',
  `detail` varchar(255) COLLATE utf8_unicode_ci DEFAULT '',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `inquiries` (`id`, `status`, `name_roma`, `name_kana`, `address_1`, `address_2`, `tel`, `email`, `requirement`, `daiichikibou`, `numbers_people`, `have_gone`, `detail`, `created_at`, `updated_at`)
VALUES
	(1,1,'abc',NULL,NULL,NULL,'abc','abc','お問い合わせ',NULL,NULL,'ある',NULL,'2017-08-11 01:45:42','2017-08-11 01:45:42'),
	(2,2,'abc',NULL,NULL,NULL,'abc','abc','お問い合わせ',NULL,NULL,'なし',NULL,'2017-08-11 01:46:48','2017-08-11 07:52:51'),
	(3,1,'abc',NULL,NULL,NULL,'abc','abc','お問い合わせ',NULL,NULL,'なし',NULL,'2017-08-11 01:57:44','2017-08-11 07:53:27'),
	(4,2,'abc',NULL,NULL,NULL,'abc','abc','お問い合わせ',NULL,NULL,'なし',NULL,'2017-08-11 01:58:31','2017-08-11 01:58:31');
...
VALUES
	...
	(13,'2017_08_11_004208_create_inquirys_table',5),
	(14,'2017_08_11_023526_create_carts_table',6),
	(15,'2017_08_11_044909_create_orders_table',7);
...
CREATE TABLE `orders` (
  ...
  `status` int(11) NOT NULL,
  `name_kanji` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `name_kana` varchar(255) COLLATE utf8_unicode_ci DEFAULT '',
  `email` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `other` varchar(255) COLLATE utf8_unicode_ci DEFAULT '',
...
INSERT INTO `orders` (`id`, `status`, `name_kanji`, `name_kana`, `email`, `address_1`, `address_2`, `tel`, `pay`, `other`, `total`, `created_at`, `updated_at`)
VALUES
	(1,1,'aaa',NULL,'aa','北海道','aa','aaa','北海道',NULL,139320,'2017-08-11 05:22:10','2017-08-11 05:22:10'),
	(2,2,'aa',NULL,'aaa','青森県','aaa','aaa','北海道',NULL,24840,'2017-08-11 05:22:51','2017-08-11 05:22:51'),
	(3,2,'123',NULL,'123','北海道','123','123','口座振り込み',NULL,41040,'2017-08-11 08:32:41','2017-08-11 08:37:43');
...
VALUES
	(1,'maicuong','cuongceopro@gmail.com','$2y$10$8MhOoYd1xs3Q7mRo8BmjwuAjUe6e5ny0/XA6z/fKCtj/lxuK3Ks/6',NULL,'2017-08-11 06:54:33','2017-08-11 06:54:33');
